...
- Avoid holidays like Ramadan (dates change yearly) if you want normal shop hours and [<u>**avoid the Eid al-Adha holiday period, when many shops and restaurants close.**</u>](https://goingmorocco.com/post/the-worst-time-to-visit-morocco)
